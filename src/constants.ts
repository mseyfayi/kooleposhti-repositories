export const appId = 167852;
export const installationId = 22704068;
export const clientId = 'Iv1.1787295e80ced193';
export const privateKey =
  ...
  '-----END RSA PRIVATE KEY-----';
export const clientSecret = '630f01bedf73947762ea5a6177effddc29f0d58b';
export const appName = 'kooleposhti-repositories-bot';
